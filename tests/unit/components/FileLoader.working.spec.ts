...
describe('FileLoader Component', () => {
  ...
  describe('File Processing', () => {
    ...
    it('should handle auto-import when enabled', async () => {
      ...
      // Spy on onImport to verify it's called
      const onImportSpy = vi.spyOn(wrapper.vm, 'onImport')
      ...
      // Verify auto-import was triggered
      expect(onImportSpy).toHaveBeenCalled()
    })
  })
})
