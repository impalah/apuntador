...
if [ ! -f "package.json" ]; then
    echo "[ERROR] Error: Run this script from the project root directory"
    exit 1
fi
...
echo "[LAUNCH] Starting iOS Simulator screenshot capture..."
...
echo "   [OK] Landscape view captured"

echo "[TIME] Rotate to portrait and adjust settings, then press ENTER..."
read -r

# Portrait with settings
xcrun simctl io "$IPAD_DEVICE" screenshot screenshots/appstore/ipad-2-portrait.png
echo "   [OK] Portrait mode captured"
