...
echo "[MOBILE] Creating splash screen with logo at 25% size..."
...
if [ -f "temp_splash/splash_25percent.png" ]; then
    echo "[OK] Custom splash screen created: temp_splash/splash_25percent.png"
    
    # Reemplazar todos los splash screens de iOS
    echo "[LIST] Replacing iOS splash screen assets..."
    ...
    echo "[OK] iOS splash screens updated with resized logo (25% of screen size)"
    echo "[IDEA] Run 'npx cap sync ios' to apply changes"
