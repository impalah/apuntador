...
try {
    ...
    Write-Host "[ERROR] Failed to generate keystore: $($_.Exception.Message)" -ForegroundColor Red
    Write-Host ""
    Write-Host "[TIP] Make sure you have Java JDK installed and keytool is in your PATH" -ForegroundColor Yellow
    exit 1
}
